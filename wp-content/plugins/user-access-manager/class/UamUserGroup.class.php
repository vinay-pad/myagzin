...
class UamUserGroup
{
    ...
    public function __construct($uamAccessHandler, $id = null)
    {
        ...
        if ($id !== null) {
            ...
            $this->groupTitle = $dbUsergroup['grouptitle'];
            $this->groupHash = $dbUsergroup['group_hash'];
    ...
    public function setGroupName($groupName)
    {
     ...
     /**
     * Sets the group Title. This is the NON-UNIQUE user friendly name that is display to the end user.
     * 
     * @param string $groupTitle The new group title.
     * 
     * @return null
     */
    public function setGroupTitle($groupTitle)
    {
     ...
     /**
     * Generates and sets the group Hash. This is used while sending out group invites as we don't want
     * to reveal any information about the group. We will use the hash instead for identification of the
     * group. Working back to the data from a hash is very very difficult.
     * 
     * @param string $groupHash The plain text email alias of the group which we will use to generate the hash.
     * 
     * @return null
     */
    public function setGroupHash($groupHash)
    {
        ...
        $this->groupHash = hash('sha256', $groupHash);
    }

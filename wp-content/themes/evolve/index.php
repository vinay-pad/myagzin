...
<style type="text/css">
	...
	.pressthis a span {
		background: url(press-this.png) no-repeat -45px 5px ;
      ...
      <?php comments_template(); ?>  
        ...
        <?php } else { ?>
				...
				<div id="post-0" class="<?php semantic_entries(); ?>">
					<!--BEGIN .entry-content-->
					<div class="entry-content">
						<h5>Welcome to <a href="http://vinpad.us/wp">myagz.in!</a><?php if (! is_user_logged_in()): ?> Please <a href="register-2">register</a> / <a href="wp-login.php">Log In</a> to start using this service <?php endif;?></h5>
...
<?php get_sidebar(); ?>
	...
	<?php 
		...
		?>
		<div class="showMsg" id="dragthis">
				<i>Drag and drop this Bookmarklet to your bookmarks bar to start sharing!<i>
				<p class="pressthis"><a href="javascript:window.open('http://vinpad.us/wp/wp.php?url='+document.URL, 'Share articles', 'height=500, width=500, left=600, top=180, location=0, scrollbars=0');"><span>myagzin!</span></a></p>
		</div>
<?php get_footer(); ?>